...
class Plotter3d:
    ...
    def _plot_edges(self, img, vertices, edges, R, poses_direction):
        ...
        cv2.line(img, tuple((poses_direction_2d* self.scale + self.origin).astype(int)) , tuple((3*poses_direction_2d* self.scale + self.origin).astype(int)), (255,255,255),1,  cv2.LINE_AA)
